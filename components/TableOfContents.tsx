...
export default function TableOfContents() {
  ...
  return (
    <aside className="hidden xl:block fixed top-60 right-10 w-64 text-sm text-gray-500 dark:text-gray-400 z-40 max-h-[70vh] overflow-y-auto border-l border-gray-100 dark:border-gray-700 pl-4">
