...
export default function ProjectTabs({ project }) {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      {/* Tab bar */}
      <div className="border-b border-gray-300 dark:border-gray-600 bg-white dark:bg-primary-dark">
      ...
      {/* Tab content */}
      <div className="mt-4 text-base sm:text-lg leading-relaxed text-gray-900 dark:text-gray-200">
